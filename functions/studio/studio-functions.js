//We want to COMPLETELY reverse an array by flipping the order of the entries AND 
//flipping the order of characters in each element.

// Part One: Reverse Characters

// 1. Define the function as reverseCharacters. Give it one parameter, 
//which will be the string to reverse.
// 2. Within the function, split the string into an array, then reverse the array.
// 3. Use join to create the reversed string and return that string from the function.
// 4. Below the function, define and initialize a variable to hold a string.
// 5. Use console.log(reverseCharacters(myVariableName)); to call the function and
// verify that it correctly reverses the characters in the string.
...
// 5. Be sure to print the result returned by the function to verify that your code works 
...
function reverseCharacters(stringToReverse) {
 ...
 console.log(reverseCharacters(4321));
...
function arrayStringReverse (arraytest) {
    let newArray = [];
...
console.log(arrayStringReverse(arrayTest3));
